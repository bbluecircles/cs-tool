...
export function AppShell({ children }: AppShellProps) {
  return (
    // Pin the whole app to the viewport height and clip overflow here, so
    // the page body never scrolls. Each page fills the main area and owns
    // its own scrolling (the resource table scrolls internally; Admin
    // scrolls its card stack).
