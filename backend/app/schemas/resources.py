...
class ChangeCustomerResponse(BaseModel):
    ...
    # Post-commit account revoke, which always runs. A failure here does
    # NOT fail the move — the user is reassigned either way, they just
    # still hold the old customer's database privileges.
    revoke_ok: bool = True
